import ContactForm from "./_components/ContactForm"; // Importing the ContactForm component

// Default export of the ContactPage component
      ...
      <div className="container mx-auto px-4 py-16 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white shadow-xl rounded-lg p-8">
            ...
            <ContactForm /> {/* Embedded contact form component */}
          </div>
