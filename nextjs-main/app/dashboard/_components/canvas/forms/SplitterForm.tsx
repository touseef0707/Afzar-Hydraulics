...
type SplitterFormProps = {
  flowId: string
  nodeId: string
  onClose: () => void
}

export default function SplitterForm({ nodeId, onClose }: SplitterFormProps) {
  ...
  return (
    <>
      <form ref={formRef} onSubmit={handleSubmit} className="feed-form-flat">
        <h2 className="form-title">Splitter/Mixer Parameters</h2>
        ...
        <div className="under-development-message">
          ...
          <p>Splitter/Mixer configuration will be available in a future update.</p>
        </div>
