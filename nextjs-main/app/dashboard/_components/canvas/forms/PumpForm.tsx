...
export default function PumpForm({ nodeId, onClose }: PumpFormProps) {
  ...
  return (
    <>
      <form ref={formRef} onSubmit={handleSubmit} className="feed-form-flat">
        <h2 className="form-title">Pump Parameters</h2>
        ...
        <div className="under-development-message">
          ...
          <p>Pump configuration will be available in a future update.</p>
        </div>
